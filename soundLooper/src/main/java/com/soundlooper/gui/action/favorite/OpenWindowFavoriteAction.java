 ...
 *-------------------------------------------------------
 */
public class OpenWindowFavoriteAction extends AbstractAction {
	 ...
	 */
	public OpenWindowFavoriteAction(WindowPlayer windowPlayer) {
		this.windowPlayer = windowPlayer;
	}

	@Override
	public void actionPerformed(ActionEvent e) {
		WindowFavorite windowFavorite = new WindowFavorite(this.windowPlayer);
		windowFavorite.setVisible(true);
	}
