 ...
 *-------------------------------------------------------
 */
public class SwitchFavoriteAction extends AbstractAction {
	...
	public void actionPerformed(ActionEvent e) {
		try {
			...
			SoundLooperPlayer.getInstance().switchFavoriteOnCurrentSong();
	...
	public boolean isEnabled() {
		return SoundLooperPlayer.getInstance().isSoundInitialized();
	}
