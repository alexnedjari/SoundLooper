...
mvn deploy:deploy-file -Durl=file:~/.m2/repository -Dfile=NativeFmodEx-win.jar -DgroupId=nativefmod -DartifactId=NativeFmodEx-win -Dpackaging=jar -Dversion=1.5.0
