...
public class CopyOfPlayerViewSkin extends SkinBase<PlayerView> {
	...
	private Border borderTop = new Border(LEFT_MARGIN);
	...
	protected CopyOfPlayerViewSkin(PlayerView control) {
		super(control);
		...
		soundLooperPlayer.markProperty().addListener(new ChangeListener<Mark>() {
			...
			public void changed(ObservableValue<? extends Mark> observable, Mark oldValue, Mark newValue) {
				CopyOfPlayerViewSkin.this.getSkinnable().forceLayout();
	...
	protected void layoutChildren(double contentX, double contentY, double contentWidth, double contentHeight) {
		...
		if (invalidWidth || invalidHeight) {
			...
			imageView.setOnMouseClicked(me -> {
				double newTimeMs = convertPxToMs(CopyOfPlayerViewSkin.this.getSkinnable().getWidth(), me.getX());
