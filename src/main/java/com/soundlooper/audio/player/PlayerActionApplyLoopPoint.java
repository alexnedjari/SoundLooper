 ...
 *        ----------------------
 */
public class PlayerActionApplyLoopPoint extends PlayerAction {
	 ...
	 *            the player
	 * @param beginPoint
	 *            the begin point in milliseconds
	 * @param endPoint
	 *            the end point in milliseconds
	 */
	public PlayerActionApplyLoopPoint(Player player, int beginPoint, int endPoint) {
		super(player);
