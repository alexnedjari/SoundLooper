 ...
 *        ====================================================================
 */
public class SoundLooperObjectAlreadyExistsException extends
	 ...
	 *            the object to add
	 */
	public SoundLooperObjectAlreadyExistsException(SoundLooperObject container,
			SoundLooperObject objectToAdd) {
		super("Object "
				+ SoundLooperObjectAlreadyExistsException
	 ...
	 *            the object to add
	 */
	public SoundLooperObjectAlreadyExistsException(String message,
